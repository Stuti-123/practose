...
<td><center><button type="button" class="btn btn-success" onclick="window.location = 'login.jsp'">Logout</button></center></td></tr>
</table>
</form>
</center>
</html>